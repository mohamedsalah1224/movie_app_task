...
part of 'known_for__model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class KnownForModelAdapter extends TypeAdapter<KnownForModel> {
  @override
  final int typeId = 2;

  @override
  KnownForModel read(BinaryReader reader) {
    ...
    return KnownForModel(
      ...
      originCountry: (fields[18] as List?)?.cast<dynamic>(),
    );
  }

  @override
  void write(BinaryWriter writer, KnownForModel obj) {
    writer
      ..writeByte(19)
      ..writeByte(0)
      ..write(obj.adult)
